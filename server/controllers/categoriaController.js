...
class CategoriaController {
    ...
    async criarCategoria(nome, descricao, imagem) {
        ...
        const categoriaCriada = await categoriaRepository.createCategoria(categoria);
    ...
    async listarCategoriaPorId(id) {
        ...
        if (!categoria) {
            return { sucesso: false, erros: [{ campo: 'id', mensagem: 'Categoria não encontrada.' }] };
        }
    ...
    async atualizarCategoria(id, nome, descricao, imagem) {
        ...
        const resultadoAtualizacao = await categoriaRepository.updateCategoria(categoriaAtualizada);
