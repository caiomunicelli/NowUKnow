...
router.post("/", verifyJWT, async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Erro ao criar comentário", details: error.message });
  }
});
...
router.get("/", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Erro ao buscar comentários", details: error.message });
  }
});
...
router.put("/:id", verifyJWT, async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Erro ao atualizar comentário", details: error.message });
  }
});
...
router.delete("/:id", verifyJWT, async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Erro ao deletar comentário", details: error.message });
  }
});
